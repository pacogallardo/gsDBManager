...
server1 = [{'host':'localhost', 'database':'gs_1', 'user':'username', 'pw':'password'}]
# connection 2 configuration
server2 = [{'host':'localhost', 'database':'gs_2', 'user':'username', 'pw':'password'}]
...
def main() : 
	...
	try :
		...
		dbM1 = DBManager(server1)
		dbM2 = DBManager(server2)
